...
public class ManageEmployee {
    ...
    public static void main(String[] args) {
        ...
        String empID1 = ME.addEmployee("Zara", "Ali", 1000);
        String empID2 = ME.addEmployee("Tara", "Das", 5000);
        String empID3 = ME.addEmployee("Oara", "Paul", 10000);
    ...
    public void updateEmployee(String EmployeeID, int salary ){
        Session session = factory.openSession();
        Transaction tx = null;
